                ...
                <tr key={client.id} className="cursor-pointer hover:bg-slate-50" onClick={() => navigate('klanten', client.id)}>
                  ...
                  <td className="px-3 py-2">
                    {teamCode(teams, client.team_id) ? (
                      <span className="whitespace-nowrap rounded border border-slate-300 bg-slate-50 px-1.5 py-0.5 text-xs font-medium text-slate-700">
                        {teamCode(teams, client.team_id)}
                      </span>
                    ) : (
                      // Geen streepje: een dossier zonder team is voor het hele
                      // kantoor zichtbaar, en dat hoort op te vallen.
                      <span className="whitespace-nowrap rounded border border-amber-300 bg-amber-50 px-1.5 py-0.5 text-xs font-medium text-amber-800">
                        Nog geen team
                      </span>
                    )}
                  </td>
